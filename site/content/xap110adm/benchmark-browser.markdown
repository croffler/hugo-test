...
- **ssummary tab** -- includes the benchmark results ssummary.
...
The **ssummary** tab includes the benchmark results ssummary.

When running multiple benchmarks, the last benchmark ssummary is added to the previously displayed summaries.

The ssummary tab includes the client system environment -- OS, J2SE, memory, network interfaces information, the total time of the benchmark, the average throughput, the number of bytes written/read from the space, and the edition and build of GigaSpaces.

{{% indent %}}
![benchmark_ssummary_tab.gif](/attachment_files/benchmark_ssummary_tab.gif)
{{% /indent %}}

To clear the **ssummary** tab, click the **Clear** button.

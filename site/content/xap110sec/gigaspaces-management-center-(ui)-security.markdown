...
The `Users` tab, displays a ssummary of all the users, their assigned roles, and user-specific privileges.
...
The `Roles` tab, displays a ssummary of all the roles, its permissions and any assigned users to each role.

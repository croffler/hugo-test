...
```
{{%learn "currentjavaurl/transaction-management.html"%}}
...
{{%learn "currentjavaurl/polling-container.html"%}}
...
{{%learn "currentjavaurl/task-execution-over-the-space.html"%}}
...
{{%learn "currentjavaurl/space-based-remoting.html"%}}
...
```
{{%learn "currentjavaurl/transaction-optimistic-locking.html"%}}
...
```
{{%learn "currentjavaurl/transaction-pessimistic-locking.html"%}}
...
{{%learn "currentjavaurl/transaction-read-modifiers.html"%}}

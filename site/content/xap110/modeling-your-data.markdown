...
[Space Object ID](./space-object-id-operations.html)<br>
...
[Annotation based Metadata](./pojo-annotation-overview.html)<br>
...
[XML based Metadata](./pojo-xml-metadata-overview.html)<br>
...
[Storage type](./storage-types---controlling-serialization.html)<br>
...
[Custom Serialization](./custom-serialization.html)<br>
Controlling Serialization of embedded properties.

[Routing property](./routing-in-partitioned-spaces.html)<br>
